...
| entrySet | PSI-MI XML 2.5 | When the _psi-mi/tab25_, _psi-mi/tab26_ or _psi-mi/tab25_ format is used, the XML file with the results is embedded in the response |
